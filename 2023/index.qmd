...
A fonte dos dados apresentados está disponibilizada [nesta página](https://aplicacoes.mds.gov.br/sagi/snas/vigilancia/index5.php) da Vigilância Socioassistencial da Secretaria Nacional de Assistência Social do Ministério do Desenvolvimento e Assistência Social, Famíia e Combate à Fome.
...
# [Indicador de Desenvolvimento dos CRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN107)
...
tabela_medias <- f_media_regiao_2_grupos(idcras_2014, `IDCRAS 2014sintético`, IBGE, "ID CRAS", "2014") %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idcras_2017, `IDCRAS médio do município`, Região, "ID CRAS", "2017")) %>%
...
O @fig-idcras-estrutura mostra a evolução ao longo dos anos das médias na [dimensão de Estrutura Física do ID CRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN104) no Brasil e Grandes Regiões.
...
O @fig-idcras-rh mostra a evolução ao longo dos anos das médias da [dimensão de Recursos Humanos do ID CRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN105) no Brasil e Grandes Regiões.
...
O @fig-idcras-servicos mostra a evolução ao longo dos anos das médias da [dimensão de Serviços & Benefícios do ID CRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN106) no Brasil e Grandes Regiões.
...
# [Indicador de Desenvolvimento dos CREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN111)
...
tabela_medias <- f_media_regiao_2_grupos(idcreas_2014, `IDCREAS sintético`, `Código IBGE`, "ID CREAS", "2014") %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idcreas_2017, `...11`, Região, "ID CREAS", "2017")) %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idcreas_2023, `...10`, Região, "ID CREAS", "2023")) %>%
...
O @fig-idcreas-estrutura mostra a evolução ao longo dos anos das médias na [dimensão de Estrutura Física do ID CREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN108) no Brasil e Grandes Regiões.
...
O @fig-idcreas-rh mostra a evolução ao longo dos anos das médias na [dimensão de Recursos Humanos do ID CREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN109) no Brasil e Grandes Regiões.
...
O @fig-idcreas-servicos mostra a evolução ao longo dos anos das médias da [dimensão de Serviços & Benefícios do ID CREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN110) no Brasil e Grandes Regiões.
...
# [Indicador de Desenvolvimento dos Conselhos](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN103)
...
O @fig-idconselho-estrutura mostra a evolução ao longo dos anos das médias na [dimensão de Estrutura Administrativa do ID Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN100) no Brasil e Grandes Regiões.
...
O @fig-idconselho-dinamica mostra a evolução ao longo dos anos das médias na [dimensão de Dinâmica de Funcionamento do ID Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN101) no Brasil e Grandes Regiões.
...
O @fig-idconselho-composicao mostra a evolução ao longo dos anos das médias da [dimensão de Composição do Conselho do ID Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN102) no Brasil e Grandes Regiões.
