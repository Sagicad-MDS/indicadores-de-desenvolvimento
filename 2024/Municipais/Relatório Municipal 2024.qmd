...
O [IDCRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN107) é um indicador sintético que retrata o grau de desenvolvimento do Centro de Referência de Assistência Social (CRAS). Ele é composto por três dimensões: [Estrutura Física](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN104), [Recursos Humanos](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN105) e [Serviços & Benefícios](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN106). Em cada dimensão, é atribuída uma nota de 1 a 5, de acordo com critérios indicativos do nível de desenvolvimento do CRAS, sendo 5 o nível máximo de desenvolvimento. O IDCRAS é a média das notas alcançadas nas três dimensões.

O @fig-ID-CRAS mostra a evolução das médias do IDCRAS ao longo dos anos no município de `r nome_municipio`, `r uf_municipio`.
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do IDCRAS, bem como os requisitos para se alcançar os níveis superiores.")
```

```{asis, echo=(n_unidades_municipio>0)}

## [IDCRAS: Dimensão Estrutura Física](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN104)
```
...
cat("Na dimensão ", dimensao, " o nível do ", equipamento, " ", capacidade, " no município de ", nome_municipio, " varia de ", menor_nivel, " a ", maior_nivel, ".", sep="")
```
...
## [IDCRAS: Dimensão Recursos Humanos](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN105)
```
...
## [IDCRAS: Dimensão Serviços & Benefícios](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN106)
```
...
* **Não realiza** alguma(s) das seguintes atividades essenciais do Serviço de Proteção e Atendimento Integral às Famílias (PAIF): **acompanhamento de famílias, e/ou grupo/oficina com famílias, e/ou visitas domiciliares, e/ou orientação**; ou
...
* **Não realiza** alguma(s) das seguintes atividades essenciais do Serviço de Proteção e Atendimento Integral às Famílias (PAIF): **acompanhamento de famílias, e/ou grupo/oficina com famílias, e/ou visitas domiciliares, e/ou orientação**; ou
* Possui **articulação frágil ou inexistente** com os Serviços de Educação, com os Serviços de Saúde e com o(s) CREAS; ou 
* Não possui profissionais de Serviço Social nem de Psicologia.
```
...
* **Executa o Serviço de Proteção e Atendimento Integral às Famílias (PAIF)**, realizando no mínimo as seguintes atividades: **acompanhamento de famílias, grupo/oficina com famílias e visitas domiciliares**; e 
...
* **Realizar no próprio CRAS o cadastramento/atualização cadastral do Cadastro Único**, sem utilizar para isso os profissionais de nível superior do PAIF.
```
...
O [IDCREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN111) é um indicador sintético que retrata o grau de desenvolvimento do Centro de Referência Especializado de Assistência Social (CREAS). Ele é composto por três dimensões: [Estrutura Física](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN108), [Recursos Humanos](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN109) e [Serviços & Benefícios](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN110). Em cada dimensão, é atribuída uma nota de 1 a 5, de acordo com critérios indicativos do nível de desenvolvimento do CREAS, sendo 5 o nível máximo de desenvolvimento. O IDCREAS é a média das notas alcançadas nas três dimensões.
...
cat("O @fig-ID-CREAS mostra a evolução das médias do IDCREAS ao longo dos anos no município de ", nome_municipio, ", ", uf_municipio, ".", sep="")
```
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do IDCREAS, bem como os requisitos para se alcançar os níveis superiores.")
```

```{asis, echo=(n_unidades_municipio>0)}

## [IDCREAS: Dimensão Estrutura Física](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN108)
```
...
* Possuir 3 salas ou mais para atendimento (5 se CREAS e sobre a Regional).
```
...
## [IDCREAS: Dimensão Recursos Humanos](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN109)
```
...
## [IDCREAS: Dimensão Serviços & Benefícios](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN110)
```
...
* Oferta o Serviço de Proteção e Atendimento Especializado a Famílias e Indivíduos (PAEFI), assegurando a realização, pelo menos, das seguintes atividades: entrevistas de acolhida para avaliação inicial dos casos, atendimento psicossocial individual/familiar, visitas domiciliares e elaboração de relatórios técnicos sobre casos em acompanhamento; e
...
* Ofertar o PAEFI, assegurando a construção do Plano Individual e/ou Familiar de Atendimento (além da realização das atividades exigidas no nível 2); e
...
* Ofertar o Serviço de MSE assegurando a realização, pelo menos, das seguintes atividades, além das atividades exigidas no nível 4: oferta das medidas de LA e PSC; acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal e atendimento do adolescente em grupos (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for CREAS Regional).
```
...
* Possuir Assistente Social e Psicólogo; e
* Funcionar no mínimo 5 dias por semana e 40 horas semanais; e
* Ofertar o Serviço de MSE, assegurando a realização, pelo menos, das seguintes atividades, além das atividades exigidas no nível 4: oferta das medidas de LA e PSC; acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal e atendimento do adolescente em grupos; e
...
* Oferta o Serviço de MSE, assegurando a realização, pelo menos, das seguintes atividades: oferta das medidas de LA e PSC; acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal; elaboração do Plano Individual de Atendimento (PIA) do adolescente e atendimento do adolescente em grupos (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for CREAS Regional); e
...
* Possui Assistente Social e Psicólogo; e
* Funciona no mínimo 5 dias por semana e 40 horas semanais; e
* Oferta o Serviço de MSE, assegurando a realização, pelo menos, das seguintes atividades: oferta das medidas de LA e PSC; acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal; elaboração do Plano Individual de Atendimento (PIA) do adolescente e atendimento do adolescente em grupos; e
...
O [IDConselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN103) é um indicador sintético que retrata o grau de desenvolvimento do Conselho Municipal de Assistência Social, com o objetivo de avaliar o controle social no SUAS. Ele é composto por três dimensões: [Estrutura Administrativa](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN100), [Dinâmica de Funcionamento](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN101) e [Composição do Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN102). Em cada dimensão, é atribuída uma nota de 1 a 5, de acordo com critérios indicativos do nível de desenvolvimento do Conselho, sendo 5 o nível máximo de desenvolvimento. O IDConselho é a média das notas alcançadas nas três dimensões.
...
cat("O @fig-ID-conselho mostra a evolução das médias do IDConselho ao longo dos anos no município de ", nome_municipio, ", ", uf_municipio, ".", sep="")
```
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do IDConselho, bem como os requisitos para se alcançar os níveis superiores.")
```

```{asis, echo=(n_unidades_municipio>0)}

## [IDConselho: Dimensão Estrutura Administrativa](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN100)
```
...
## [IDConselho: Dimensão Dinâmica de Funcionamento](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN101)
```
...
## [IDConselho: Dimensão Composição do Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN102)
```
