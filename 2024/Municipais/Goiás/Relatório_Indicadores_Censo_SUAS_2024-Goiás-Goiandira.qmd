...
nome_municipio <- case_when(
                    municipio == "330455" | # Rio de Janeiro e Crato tem artigo
                    municipio == "230420" ~ sprintf("no %s", nome_municipio),
                    .default = sprintf("em %s", nome_municipio) # Todos os outros não tem
                  )
...
---
subtitle: "Relatório de Indicadores Censo SUAS 2024 `r nome_municipio`, `r uf_municipio`"
---

# Introdução

Este relatório apresenta os resultados dos indicadores de desenvolvimento do Censo SUAS para o ano de 2024, `r nome_municipio`, `r uf_municipio`, bem como a evolução desses indicadores desde 2014. Apresenta ainda os requisitos necessários para estar nos níveis mais baixos encontrados `r nome_municipio` em cada uma das dimensões de cada indicador, e os requisitos para atingir os níveis mais altos.
...
O @fig-ID-CRAS mostra a evolução das médias do {{< acr IDCRAS >}} ao longo dos anos `r nome_municipio`.

```{r fig-ID-CRAS, fig.cap = sprintf("Evolução das médias do IDCRAS de 2014 a 2024 %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 10
...
```{r fig-ID-CRAS-nivel, fig.cap = sprintf("Quantidade de CRAS em cada nível das dimensões do IDCRAS em 2024, %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=n_unidades_municipio>1}
...
tabela <- unidades_municipio %>%
            tabyl(q1) %>%
            select(q1, n) %>%
            kable(caption=sprintf("Quantidade de CRAS em 2024 %s, por capacidade de referenciamento.", nome_municipio),
...
cat("As seções a seguir apresentam os resultados", nome_municipio, "em cada uma das dimensões do {{< acr IDCRAS >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
...
cat("Não tem ", equipamento, " ", capacidade, " ", nome_municipio, ".", sep="")
```
...
cat("Na dimensão ", dimensao, " o nível do ", equipamento, " ", capacidade, " ", nome_municipio, " é ",  menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel==maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " o nível dos ", equipamento, " ", capacidade, " ", nome_municipio, " é ", menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel<maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " os níveis dos ", equipamento, " ", capacidade, " ", nome_municipio, " variam de ", menor_nivel, " a ", maior_nivel, ".", sep="")
```
...
cat("Na dimensão ", dimensao, " o nível do ", equipamento, " ", nome_municipio, " é ",  menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel==maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " o nível dos ", equipamento, " ", nome_municipio, " é ", menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel<maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " os níveis dos ", equipamento, " ", nome_municipio, " variam de ", menor_nivel, " a ", maior_nivel, ".", sep="")
```
...
cat("Não tem ", equipamento, " ", nome_municipio, ".", sep="")
```

```{r eval=(existe_equipamento>0), results='asis'}

cat("O @fig-ID-CREAS mostra a evolução das médias do {{< acr IDCREAS >}} ao longo dos anos ", nome_municipio, ", ", uf_municipio, ".", sep="")
```

```{r fig-ID-CREAS, fig.cap = sprintf("Evolução das médias do IDCREAS de 2014 a 2024 %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=(existe_equipamento>0)}
#| fig-height: 10
...
```{r fig-ID-CREAS-nivel, fig.cap = sprintf("Quantidade de CREAS em cada nível das dimensões do IDCREAS em 2024, %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=n_unidades_municipio>1}
...
cat("As seções a seguir apresentam os resultados", nome_municipio, "em cada uma das dimensões do {{< acr IDCREAS >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
...
cat("O @fig-ID-conselho mostra a evolução das médias do {{< acr IDConselho >}} ao longo dos anos ", nome_municipio, ", ", uf_municipio, ".", sep="")
```

```{r fig-ID-conselho, fig.cap = sprintf("Evolução das médias do IDConselho de 2014 a 2024 %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=(existe_equipamento>0)}
#| fig-height: 10
...
cat("As seções a seguir apresentam os resultados", nome_municipio, "em cada uma das dimensões do {{< acr IDConselho >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
