...
# municipio: 521925 # Sem nota de Conselho em 2023
...
porte_cras <- idcras_2024  %>%
                filter(`Código IBGE` == municipio)  %>%
                select(Porte)
porte_creas <- idcreas_2024  %>%
                filter(`Código IBGE` == municipio)  %>%
                select(Porte)
porte_conselho <- idconselho_2024  %>%
...
---
subtitle: "Relatório de Indicadores Censo SUAS 2024 do município de `r nome_municipio`, `r uf_municipio`"
---

# Introdução

Este relatório apresenta os resultados dos indicadores de desenvolvimento do Censo SUAS para o ano de 2024, no município de `r nome_municipio`, `r uf_municipio`, bem como a evolução desses indicadores desde 2014. Apresenta ainda os requisitos necessários para estar nos níveis mais baixos encontrados no Município em cada uma das dimensões de cada indicador, e os requisitos para atingir os níveis mais altos.
...
O @fig-ID-CRAS mostra a evolução das médias do {{< acr IDCRAS >}} ao longo dos anos no município de `r nome_municipio`, `r uf_municipio`.

```{r fig-ID-CRAS, fig.cap = sprintf("Evolução das médias do IDCRAS, 2014 a 2024: %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS."}
#| fig-height: 10

  f_selecao_grupo_media(idcras_2014, IBGE, municipio, `IDCRAS 2014sintético`, "IDCRAS", "2014") %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2015, IBGE, municipio, `IDCRAS 2015 sintético`, "IDCRAS", "2015")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2016, IBGE, municipio, `IDCRAS 2016sintético`, "IDCRAS", "2016")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2017, `IBGE`, municipio, `IDCRAS médio do município`, "IDCRAS", "2017")) %>%
  bind_rows(f_selecao_grupo_media(idcras_2017, `IBGE`, municipio, `Estrutura Física`, "Estrutura Física", "2017")) %>%
  bind_rows(f_selecao_grupo_media(idcras_2017, `IBGE`, municipio, `Recursos Humanos`, "Recursos Humanos", "2017")) %>%
  bind_rows(f_selecao_grupo_media(idcras_2017, `IBGE`, municipio, `Serviços `, "Serviços & Benefícios", "2017")) %>%
  
  bind_rows(f_selecao_grupo_media(idcras_2018, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2018")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2019, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2019")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2020, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2020")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2021, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2021")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcras_2022, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2022")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idcras_2023, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2023")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idcras_2024, `Código IBGE`, municipio, IDCRAS, "IDCRAS", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcras_2024, `Código IBGE`, municipio, `Estrutura Física`, "Estrutura Física", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcras_2024, `Código IBGE`, municipio, `Recursos Humanos`, "Recursos Humanos", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcras_2024, `Código IBGE`, municipio, `Serviços `, "Serviços & Benefícios", "2024")) %>% 
  ...
  f_grafico_col_numero_flip_2_x(Grupo, m, Eixo_X)

```

```{r}
unidades_municipio <- idcras_2024 %>%
                       filter(`Código IBGE` == municipio)

n_unidades_municipio <- nrow(unidades_municipio)
```

```{r fig-ID-CRAS-nivel, fig.cap = sprintf("Quantidade de CRAS em cada nível das dimensões do IDCRAS, 2024: %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=n_unidades_municipio>1}

  f_quantitativo_niveis_filtro(idcras_2024, `Código IBGE`, municipio, `Estrutura Física`, "Estrutura Física", niveis_ID) %>% 
  bind_rows(f_quantitativo_niveis_filtro(idcras_2024, `Código IBGE`, municipio, `Recursos Humanos`, "Recursos Humanos", niveis_ID)) %>%
  bind_rows(f_quantitativo_niveis_filtro(idcras_2024, `Código IBGE`, municipio, `Serviços `, "Serviços & Benefícios", niveis_ID)) %>% 

  mutate(Eixo_X = factor(Eixo_X, levels = c("Estrutura Física",
                                            "Recursos Humanos",
                                            "Serviços & Benefícios"))) %>% 

  f_grafico_col_numero_flip_2_x(Eixo_X, n, Grupo)
...
tabela <- unidades_municipio %>%
            tabyl(q1) %>%
            select(q1, n) %>%
            kable(caption=sprintf("Quantidade de CRAS em 2024 no município de %s por capacidade de referenciamento.", nome_municipio),
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do {{< acr IDCRAS >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
...
cat("Na dimensão ", dimensao, " o nível do ", equipamento, " ", capacidade, " no município de ", nome_municipio, " é ",  menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel==maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " o nível dos ", equipamento, " ", capacidade, " no município de ", nome_municipio, " é ", menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel<maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " os níveis dos ", equipamento, " ", capacidade, " no município de ", nome_municipio, " variam de ", menor_nivel, " a ", maior_nivel, ".", sep="")
```
...
* Possuir no mínimo **4** (6, se {{< acr EV >}}) profissionais, sendo pelo menos **2** (4, se {{< acr EV >}}) com nível superior; e
* Possuir no mínimo **1 Assistente Social** (2, se {{< acr EV >}}).
```
...
* Possuir no mínimo **4** (7, se {{< acr EV >}}) profissionais, sendo pelo menos **3** (5, se {{< acr EV >}}) com nível superior; e
...
* Possuir no mínimo **5** (9, se {{< acr EV >}}) **profissionais**, sendo pelo menos **3** (5, se {{< acr EV >}}) com **nível superior**; e 
...
* Possuir no mínimo **6** (8, se {{< acr EV >}}) profissionais, sendo pelo menos **3** (4, se {{< acr EV >}}) com nível superior; e
* Possuir no mínimo **2 Assistentes Sociais** (3, se {{< acr EV >}}).
```
...
* Possuir no mínimo **6** (9, se {{< acr EV >}}) profissionais, sendo pelo menos **4** (6, se {{< acr EV >}}) com nível superior; e
* Possuir **coordenador** com nível superior.
```
...
* Possuir no mínimo **7** (11, se {{< acr EV >}}) **profissionais**, sendo pelo menos **4** (6, se {{< acr EV >}}) com **nível superior**; e
* Possuir no mínimo **1 Psicólogo**; e 
* Possuir no mínimo **1** profissional de nível superior com **vínculo estatutário ou empregado público celetista**.
```
...
* Possuir no mínimo **7** (9, se {{< acr EV >}}) profissionais, sendo pelo menos **4** (6, se {{< acr EV >}}) com nível superior; e
* Possuir no mínimo **2 Assistentes Sociais** (3, se {{< acr EV >}}).
```
...
* Possuir no mínimo **7** (10, se {{< acr EV >}}) profissionais, sendo pelo menos **5** (7, se {{< acr EV >}}) com nível superior; e
* Possuir no mínimo **1 Psicólogo**; e 
* Possuir **coordenador** com nível superior.
```
...
* Possuir no mínimo **9** (13, se {{< acr EV >}}) **profissionais**, sendo pelo menos **5** (7, se {{< acr EV >}}) com **nível superior**; e
...
cat("Na dimensão ", dimensao, " o nível do ", equipamento, " no município de ", nome_municipio, " é ",  menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel==maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " o nível dos ", equipamento, " no município de ", nome_municipio, " é ", menor_nivel, ".", sep="")
```

```{r eval=(n_unidades>1 && menor_nivel<maior_nivel), results='asis'}

cat("Na dimensão ", dimensao, " os níveis dos ", equipamento, " no município de ", nome_municipio, " variam de ", menor_nivel, " a ", maior_nivel, ".", sep="")
```
...
* **Não realiza** alguma(s) das seguintes atividades essenciais do {{< acr PAIF >}}: **acompanhamento de famílias, e/ou grupo/oficina com famílias, e/ou visitas domiciliares, e/ou orientação**; ou
* Possui **articulação frágil ou inexistente** com os Serviços de Educação, com os Serviços de Saúde e com o(s) {{< acr CREAS >}}; ou 
* Não possui profissionais de Serviço Social nem de Psicologia.
```
...
* **Executar o {{< acr PAIF >}}**, realizando no mínimo as seguintes atividades: **acompanhamento de famílias, grupo/oficina com famílias e visitas domiciliares**; e 
...
* **Executar o {{< acr PAIF >}}**, realizando no mínimo as seguintes atividades: **acompanhamento de famílias, grupo/oficina com famílias e visitas domiciliares**; e 
* Possuir **forte articulação com pelo menos um dos seguintes serviços: Serviços de Educação, Serviços de Saúde e {{< acr CREAS >}}**.
```
...
* **Executar o {{< acr PAIF >}}**, realizando **orientação/acompanhamento para inserção no {{< acr BPC >}}**, além das atividades exigidas para o nível 2; e
* Possuir oferta de Serviço de Convivência **pelo menos para um ciclo de vida** (oferta direta do {{< acr CRAS >}} ou por meio de unidades a ele referenciadas); e
...
* **Executar o {{< acr PAIF >}}**, realizando **orientação/acompanhamento para inserção no {{< acr BPC >}}**, além das atividades exigidas para o nível 2; e
* Possuir oferta de Serviço de Convivência **pelo menos para um ciclo de vida** (oferta direta do {{< acr CRAS >}} ou por meio de unidades a ele referenciadas); e
* Possuir **forte articulação com o(s) {{< acr CREAS >}} e com os Serviços de Educação e Saúde** no território.
```
...
* **Executar o {{< acr PAIF >}}**, realizando **palestras, campanhas ou eventos comunitários e acompanhamento dos encaminhamentos realizados**, além das atividades exigidas para o nível 3; e
* Possuir oferta de Serviço de Convivência **para no mínimo dois ciclos de vida** (oferta direta do {{< acr CRAS >}} ou por meio de unidades a ele referenciadas); e
...
* Possuir oferta de Serviço de Convivência, **para no mínimo três ciclos de vida** (oferta direta do {{< acr CRAS >}} ou por meio de unidades a ele referenciadas); e
* **Realizar no próprio {{< acr CRAS >}} o cadastramento/atualização cadastral do Cadastro Único**, sem utilizar para isso os profissionais de nível superior do {{< acr PAIF >}}.
```
...
tabela <- f_selecao_grupo_media(idcreas_2014, `Código IBGE`, municipio, `IDCREAS sintético`, "IDCREAS", "2014") %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2015, IBGE6, municipio, `IDCREAS sintético`, "IDCREAS", "2015")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2016, IBGE, municipio, `IDCREAS 2016`, "IDCREAS", "2016")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2017, `Código IBGE`, municipio, `IDCREAS`, "IDCREAS", "2017")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2018, IBGE, municipio, ID_CREAS, "IDCREAS", "2018")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2019, IBGE, municipio, ID_CREAS, "IDCREAS", "2019")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2020, IBGE, municipio, ID_CREAS, "IDCREAS", "2020")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2021, IBGE, municipio, ID_CREAS, "IDCREAS", "2021")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2022, `Código IBGE`, municipio, IDCREAS, "IDCREAS", "2022")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2023, `Código IBGE`, municipio, `IDCREAS`, "IDCREAS", "2023")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idcreas_2024, `Código IBGE`, municipio, `IDCREAS`, "IDCREAS", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcreas_2024, `Código IBGE`, municipio, `Estrutura Física`, "Estrutura Física", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcreas_2024, `Código IBGE`, municipio, `Recursos Humanos`, "Recursos Humanos", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idcreas_2024, `Código IBGE`, municipio, `Serviços `, "Serviços & Benefícios", "2024")) %>% 
...
cat("O @fig-ID-CREAS mostra a evolução das médias do {{< acr IDCREAS >}} ao longo dos anos no município de ", nome_municipio, ", ", uf_municipio, ".", sep="")
```

```{r fig-ID-CREAS, fig.cap = sprintf("Evolução das médias do IDCREAS, 2014 a 2024: %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=(existe_equipamento>0)}
#| fig-height: 10
...
```{r}
unidades_municipio <- idcreas_2024 %>%
                       filter(`Código IBGE` == municipio)
...
```{r fig-ID-CREAS-nivel, fig.cap = sprintf("Quantidade de CREAS em cada nível das dimensões do IDCREAS, 2024: %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=n_unidades_municipio>1}

  f_quantitativo_niveis_filtro(idcreas_2024, `Código IBGE`, municipio, `Estrutura Física`, "Estrutura Física", niveis_ID) %>% 
  bind_rows(f_quantitativo_niveis_filtro(idcreas_2024, `Código IBGE`, municipio, `Recursos Humanos`, "Recursos Humanos", niveis_ID)) %>%
  bind_rows(f_quantitativo_niveis_filtro(idcreas_2024, `Código IBGE`, municipio, `Serviços `, "Serviços & Benefícios", niveis_ID)) %>% 
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do {{< acr IDCREAS >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
...
* Possuir 3 salas ou mais para atendimento (5 se {{< acr CREAS >}} e sobre a Regional).
```
...
* Possuir acessibilidade (com ou sem {{< acr ABNT >}}); e
...
* Ter quantidade total de trabalhadores (nível superior e médio) maior ou igual a 3 (6, se {{< acr CREAS >}} Regional); e
* Possuir no mínimo 1 Assistente Social e 1 Psicólogo (além disso, se for {{< acr CREAS >}} Regional, o total de Assistentes Sociais mais Psicólogos deve ser maior ou igual a 4).
```
...
* Ter quantidade total de trabalhadores (nível superior e médio) maior ou igual a 5 (10, se {{< acr CREAS >}} Regional), sendo no mínimo 3 (5, se {{< acr CREAS >}} Regional) deles de nível superior.
```
...
* Ter no mínimo 4 trabalhadores de nível superior (6, se {{< acr CREAS >}} Regional).
```
...
* Ter quantidade total de trabalhadores (nível superior e médio) maior ou igual a 7 (14, se {{< acr CREAS >}} Regional, sendo neste caso no mínimo 7 de nível superior); e
* Se for {{< acr CREAS >}} Regional, possuir no mínimo 2 Assistentes Sociais; e
* Se for {{< acr CREAS >}} Regional, possuir no mínimo 2 Psicólogos; e
* Possuir no mínimo 1 (2, se {{< acr CREAS >}} Regional) trabalhador de nível superior com vínculo estatutário ou empregado público celetista.
```
...
* Ofertar o {{< acr PAEFI >}}, assegurando a realização, pelo menos, das seguintes atividades: entrevistas de acolhida para avaliação inicial dos casos, atendimento psicossocial individual/familiar, visitas domiciliares e elaboração de relatórios técnicos sobre casos em acompanhamento; e
* Possuir forte articulação com o {{< acr CRAS >}}.
```
...
* Ofertar o {{< acr PAEFI >}}, assegurando a construção do Plano Individual e/ou Familiar de Atendimento (além da realização das atividades exigidas no nível 2); e
...
* Ofertar o Serviço de {{< acr MSE >}} (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for {{< acr CREAS >}} Regional).
```
...
* Ofertar o {{< acr PAEFI >}}, assegurando a realização da atividade de atendimento psicossocial em grupo (além da realização das atividades exigidas no nível 3); e
* Ter quantidade média de casos em acompanhamento no mês, dividida pela equipe técnica (Assistente Social + Psicólogo) menor ou igual a 50 casos; e
* Ofertar o Serviço de {{< acr MSE >}} assegurando a elaboração do {{< acr PIA >}} do adolescente (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for {{< acr CREAS >}} Regional); e
* Ofertar o Serviço de Abordagem ou ter o Serviço referenciado (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for {{< acr CREAS >}} Regional).
```
...
* Ofertar o {{< acr PAEFI >}}, assegurando a realização da atividade de atendimento psicossocial em grupo (além da realização das atividades exigidas no nível 3); e
* Ter quantidade média de casos em acompanhamento no mês, dividida pela equipe técnica (Assistente Social + Psicólogo) menor ou igual a 50 casos; e
* Ofertar o Serviço de {{< acr MSE >}} assegurando a elaboração do {{< acr PIA >}} do adolescente; e
...
* Tem quantidade média de casos em acompanhamento no mês, dividida pela equipe técnica (Assistente Social + Psicólogo) menor ou igual a 50 casos; e
* Oferta atendimento para variadas situações de violência ou violação de direitos e para os diferentes ciclos de vida; e
* Possui forte articulação com o {{< acr CRAS >}} e com o Conselho Tutelar; e
...
* Ofertar o {{< acr PAEFI >}}, assegurando a realização de ações de mobilização e sensibilização para o enfrentamento das situações de violação de direitos (além da realização das atividades exigidas no nível 4); e
* Ter quantidade média de casos em acompanhamento no mês, dividida pela equipe técnica (Assistente Social + Psicólogo) menor ou igual a 30 casos; e
* Possuir Assistente Social e Psicólogo; e
* Funcionar no mínimo 5 dias por semana e 40 horas semanais; e
* Ofertar o Serviço de {{< acr MSE >}} assegurando a realização, pelo menos, das seguintes atividades, além das atividades exigidas no nível 4: oferta das medidas de {{< acr LA >}} e {{< acr PSC >}}; acompanhamento de {{< acr LA >}} e {{< acr PSC >}}, com frequência de atendimento semanal ou quinzenal e atendimento do adolescente em grupos (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for {{< acr CREAS >}} Regional).
```
...
* Possuir Assistente Social e Psicólogo; e
* Funcionar no mínimo 5 dias por semana e 40 horas semanais; e
* Ofertar o Serviço de {{< acr MSE >}}, assegurando a realização, pelo menos, das seguintes atividades, além das atividades exigidas no nível 4: oferta das medidas de {{< acr LA >}} e {{< acr PSC >}}; acompanhamento de {{< acr LA >}} e {{< acr PSC >}}, com frequência de atendimento semanal ou quinzenal e atendimento do adolescente em grupos; e
...
* Oferta atendimento para variadas situações de violência ou violação de direitos e para os diferentes ciclos de vida; e
* Tem quantidade média de casos em acompanhamento no mês, dividida pela equipe técnica (Assistente Social + Psicólogo) menor ou igual a 30 casos; e
* Possui Assistente Social e Psicólogo; e
* Funciona no mínimo 5 dias por semana e 40 horas semanais; e
* Oferta o Serviço de {{< acr MSE >}}, assegurando a realização, pelo menos, das seguintes atividades: oferta das medidas de {{< acr LA >}} e {{< acr PSC >}}; acompanhamento de {{< acr LA >}} e {{< acr PSC >}}, com frequência de atendimento semanal ou quinzenal; elaboração do {{< acr PIA >}} do adolescente e atendimento do adolescente em grupos (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for {{< acr CREAS >}} Regional); e
...
* Mantém forte articulação com o {{< acr CRAS >}}, com o Conselho Tutelar e com Serviços de Acolhimento; e
* Oferta o Serviço de Abordagem ou tem o Serviço referenciado.
```
...
tabela <- f_selecao_grupo_media(idconselho_2014, IBGE, municipio, IDConselho, "IDConselho", "2014") %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2015, IBGE, municipio, `IDConselho - 2015`, "IDConselho", "2015")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2016, IBGE, municipio, IDConselho, "IDConselho", "2016")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2017, IBGE, municipio, IDConselho, "IDConselho", "2017")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2018, IBGE, municipio, IDConselho, "IDConselho", "2018")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2019, IBGE, municipio, IDConselho, "IDConselho", "2019")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2020, IBGE, municipio, IDConselho, "IDConselho", "2020")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2021, IBGE, municipio, IDConselho, "IDConselho", "2021")) %>%
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2022, IBGE7, municipio, IDConselho, "IDConselho", "2022")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2023, IBGE, municipio, IDConselho, "IDConselho", "2023")) %>% 
  ...
  bind_rows(f_selecao_grupo_media(idconselho_2024, IBGE, municipio, IDConselho, "IDConselho", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idconselho_2024, IBGE, municipio, `Estrutura Administrativa`, "Estrutura Administrativa", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idconselho_2024, IBGE, municipio, `Dinâmica de Funcionamento`, "Dinâmica de Funcionamento", "2024")) %>% 
  bind_rows(f_selecao_grupo_media(idconselho_2024, IBGE, municipio, `Composição do Conselho`, "Composição do Conselho", "2024")) %>% 
...
cat("O @fig-ID-conselho mostra a evolução das médias do {{< acr IDConselho >}} ao longo dos anos no município de ", nome_municipio, ", ", uf_municipio, ".", sep="")
```

```{r fig-ID-conselho, fig.cap = sprintf("Evolução das médias do IDConselho, 2014 a 2024: %s, %s", nome_municipio, uf_municipio), fig.footer = "Fonte: MDS, Censo SUAS.", eval=(existe_equipamento>0)}
#| fig-height: 10
...
```{r}
unidades_municipio <- idconselho_2024 %>%
                       filter(IBGE == municipio) %>%
                       filter(!is.na(IDConselho))
...
cat("As seções a seguir apresentam os resultados do município de", nome_municipio, "em cada uma das dimensões do {{< acr IDConselho >}}, bem como os requisitos para se alcançar os níveis superiores.")
```
...
* Possuir previsão de recursos na Lei Orçamentária Anual ou utilizar para as despesas de seu funcionamento o mínimo de 3% do {{< acr IGD >}}; e
...
* Utilizar para as despesas de seu funcionamento o mínimo de 3% do {{< acr IGD >}}; e
