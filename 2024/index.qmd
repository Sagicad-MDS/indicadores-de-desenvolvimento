...
As principais fontes de dados para o cálculo dos Indicadores são o Censo SUAS e o Registro Mensal de Atendimentos (RMA), e os resultados, utilizados na elaboração destes relatórios, estão disponibilizados [nesta página](https://aplicacoes.mds.gov.br/sagi/snas/vigilancia/index5.php) da Vigilância Socioassistencial da Secretaria Nacional de Assistência Social, do Ministério do Desenvolvimento e Assistência Social, Família e Combate à Fome.
