...
Os Indicadores Censo SUAS são indicadores sintéticos que retratam o grau de desenvolvimento das unidades do Sistema Único de Assistência Social (SUAS). Esta publicação contém um relatório com resultados nacionais e por regiões, e relatórios municipais individualizados para cada um dos 5.570 municípios brasileiros.

As principais fontes de dados são o Censo SUAS e o Registro Mensal de Atendimentos (RMA) e as informações estão disponibilizadas [nesta página](#0) da Vigilância Socioassistencial da Secretaria Nacional de Assistência Social, do Ministério do Desenvolvimento e Assistência Social, Família e Combate à Fome.
...
tabela_medias <- f_media_regiao_2_grupos(idcras_2014, `IDCRAS 2014sintético`, IBGE, "ID CRAS", "2014") %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idcras_2024, IDCRAS, Região, "ID CRAS", "2024")) %>%
...
tabela <- cras_por_capacidade %>%
            tabyl(q1) %>%
            select(q1, n) %>%
            kable(caption=sprintf("Quantidade de %s em 2024 no Brasil por capacidade de referenciamento.", equipamento),
...
O @fig-idcras-estrutura mostra a evolução ao longo dos anos das médias na [dimensão Estrutura Física do IDCRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN104) no Brasil e nas grandes regiões.
...
```{r fig-idcras-niveis-estrutura, fig.cap = "Dimensão Estrutura Física do ID CRAS, quantitativo de CRAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCRAS na dimensão Estrutura Física, de acordo com a capacidade de referenciamento do CRAS.
...
O @fig-idcras-rh mostra a evolução ao longo dos anos das médias da [dimensão Recursos Humanos do IDCRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN105) no Brasil e nas grandes regiões.
...
```{r fig-idcras-niveis-rh, fig.cap = "Dimensão Recursos Humanos do ID CRAS, quantitativo de CRAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCRAS na dimensão Recursos Humanos, de acordo com a capacidade de referenciamento do CRAS.
...
O @fig-idcras-servicos mostra a evolução ao longo dos anos das médias da [dimensão Serviços & Benefícios do IDCRAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN106) no Brasil e nas grandes regiões.
...
```{r fig-idcras-niveis-servicos, fig.cap = "Dimensão Serviços & Benefícios do ID CRAS, quantitativo de CRAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCRAS na dimensão Serviços & Benefícios, de acordo com o porte do município onde está o CRAS.
...
-   Possui **articulação frágil ou inexistente** com os Serviços de Educação, com os Serviços de Saúde e com os Centros de Referência Especializados de Assistência Social (CREAS); ou
-   Não possui profissionais de Serviço Social nem de Psicologia.
...
O Indicador de Desenvolvimento do CREAS ([IDCREAS](#0)) é um indicador sintético que retrata o grau de desenvolvimento do CREAS. Ele é composto por três dimensões: [Estrutura Física](#0), [Recursos Humanos](#0) e [Serviços & Benefícios](#0). Em cada dimensão, é atribuída uma nota de 1 a 5, de acordo com critérios indicativos do nível de desenvolvimento do CREAS, sendo 5 o nível máximo de desenvolvimento. O IDCREAS é a média das notas alcançadas nas três dimensões.

O @fig-idcreas mostra a evolução das médias do IDCREAS ao longo dos anos no Brasil e nas grandes regiões.
...
tabela_medias <- f_media_regiao_2_grupos(idcreas_2014, `IDCREAS sintético`, `Código IBGE`, "ID CREAS", "2014") %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idcreas_2024, `IDCREAS`, Região, "ID CREAS", "2024")) %>%
...
O @fig-idcreas-estrutura mostra a evolução ao longo dos anos das médias na [dimensão Estrutura Física do IDCREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN108) no Brasil e nas grandes regiões.
...
```{r fig-idcreas-niveis-estrutura, fig.cap = "Dimensão Estrutura Física do ID CREAS, quantitativo de CREAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCREAS na dimensão Estrutura Física, de acordo com o porte do município onde está o CREAS.
...
O @fig-idcreas-rh mostra a evolução ao longo dos anos das médias na [dimensão Recursos Humanos do IDCREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN109) no Brasil e nas grandes regiões.
...
```{r fig-idcreas-niveis-rh, fig.cap = "Dimensão Recursos Humanos do ID CREAS, quantitativo de CREAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCREAS na dimensão Recursos Humanos, de acordo com o porte do município onde está o CREAS.
...
O @fig-idcreas-servicos mostra a evolução ao longo dos anos das médias da [dimensão Serviços & Benefícios do IDCREAS](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN110) no Brasil e nas grandes regiões.
...
```{r fig-idcreas-niveis-servicos, fig.cap = "Dimensão Serviços & Benefícios do ID CREAS, quantitativo de CREAS em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDCREAS na dimensão Serviços & Benefícios, de acordo com o porte do município onde está o CREAS.
...
-   Oferta o Serviço de MSE, assegurando a realização, pelo menos, das seguintes atividades: oferta as medidas de Liberdade Assistida (LA) e de Prestação de Serviços à Comunidade (PSC); acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal; elaboração do PIA do adolescente e atendimento do adolescente em grupos (APLICA-SE SOMENTE SE O MUNICÍPIO RECEBER COFINANCIAMENTO ou se for CREAS Regional); e
...
-   Possui Assistente Social e Psicólogo; e
-   Funciona no mínimo 5 dias por semana e 40 horas semanais; e
-   Oferta o Serviço de MSE, assegurando a realização, pelo menos, das seguintes atividades: oferta LA e PSC; acompanhamento de LA e PSC, com frequência de atendimento semanal ou quinzenal; elaboração do PIA do adolescente e atendimento do adolescente em grupos; e
...
O Indicador de Desenvolvimento do Conselho ([IDConselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN103)) é um indicador sintético que retrata o grau de desenvolvimento do Conselho, com o objetivo de avaliar o controle social no SUAS. Ele é composto por três dimensões: [Estrutura Administrativa](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN100), [Dinâmica de Funcionamento](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN101) e [Composição do Conselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN102). Em cada dimensão, é atribuída uma nota de 1 a 5, de acordo com critérios indicativos do nível de desenvolvimento do Conselho, sendo 5 o nível máximo de desenvolvimento. O IDConselho é a média das notas alcançadas nas três dimensões.

O @fig-idconselho mostra a evolução das médias do IDConselho ao longo dos anos no Brasil e nas grandes regiões.
...
tabela_medias <- f_media_regiao_2_grupos(idconselho_2014, IDConselho, IBGE, "ID Conselho", "2014") %>%
  ...
  bind_rows(f_media_regiao_2_grupos(idconselho_2024, IDConselho, IBGE7, "ID Conselho", "2024")) %>%
...
O @fig-idconselho-estrutura mostra a evolução ao longo dos anos das médias na [dimensão Estrutura Administrativa do IDConselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN100) no Brasil e nas grandes regiões.
...
```{r fig-idconselho-niveis-estrutura, fig.cap = "Dimensão Estrutura Administrativa do ID Conselho, quantitativo de Conselhos em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDConselho na dimensão Estrutura Administrativa, de acordo com o porte do município onde está o Conselho.
...
O @fig-idconselho-dinamica mostra a evolução ao longo dos anos das médias na [dimensão Dinâmica de Funcionamento do IDConselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN101) no Brasil e nas grandes regiões.
...
```{r fig-idconselho-niveis-dinamica, fig.cap = "Dimensão Dinâmica de Funcionamento do ID Conselho, quantitativo de Conselhos em cada nível, 2024."}
...
Os requisitos para cada nível do IDConselho na dimensão Dinâmica de Funcionamento são descritos a seguir:
...
O @fig-idconselho-composicao mostra a evolução ao longo dos anos das médias da [dimensão Composição do Conselho do IDConselho](https://wiki-sagi.mds.gov.br/en/home/DS/SUAS/I/IN102) no Brasil e nas grandes regiões.
...
```{r fig-idconselho-niveis-composicao, fig.cap = "Dimensão Composição do Conselho do ID Conselho, quantitativo de Conselhos em cada nível, 2024."}
...
As subseções a seguir descrevem os requisitos para cada nível do IDConselho na dimensão Composição do Conselho, de acordo com o porte do município onde está o Conselho.
